...
class AudioManager:
    ...
    '''
    curl ^
    -H "Authorization: Bearer DIQXXDPDBC3Q6WN2IA45HZEFRWGGMBSE" ^
    "https://api.wit.ai/message?v=20230605&q=robotanica"
    '''

    def __init__(self, logger, config_file, display_man, sound_man, porcupineApiKey="h0YDR3lHjiS+zfe8nUHiFsaJ1oJwB8q/+EHPCqTDYX3OIAAWX0Huiw==", withAiApiKey="2FGIGDOM66YLQLBDBKRWV2VCDRHVDE3O"):
        ...
        self.wakeWord = "computer"
        self.porc = pvporcupine.create(access_key=access_key_porcupine, keywords=[self.wakeWord])
